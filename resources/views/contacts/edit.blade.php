...
@section('content')
    <div class="card card-custom">
        ...
        <form id="personal-info-form" method="POST" action="{{ route('contacts.update',$contact) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{asset('admin/assets/media/users/blank2.png')}})">
                            <div class="image-input-wrapper" style="background-image: url({{  $contact->image ? asset($contact->image) : asset('admin/assets/media/users/300_21.jpg') }})"></div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control form-control-lg form-control-solid" type="text"
                               value="{{ old('fname', $contact->fname) }}" name="fname"  placeholder="First name" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">Last Name<span
                            class="text-danger">*</span></label>
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control form-control-lg form-control-solid" name="lname" type="text" value="{{ old('lname', $contact->lname) }}" placeholder="Last name">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">Date of Birth</label>
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control form-control-lg form-control-solid" name="dob" type="date" value="{{ old('dob', $contact->dob) }}" placeholder="DOB">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">Job</label>
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control form-control-lg form-control-solid" name="job" type="text" value="{{ old('job', $contact->job) }}" placeholder="Job">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <select name="language" id="language" class="form-control form-control-solid h-auto py-7 px-6 border-0 rounded-lg font-size-h6">
                            ...
                            <option value="French" {{ $contact->language == 'French' ? 'selected' : '' }}>French</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <select name="education" id="education"
                            ...
                            <option value="High School" {{ $contact->education === 'High School' ? 'selected' : '' }}>High School</option>
                            <option value="Diploma Degree" {{ $contact->education === 'Diploma Degree' ? 'selected' : '' }}>Diploma degree</option>
                            <option value="Bachelor Degree" {{ $contact->education === 'Bachelor Degree' ? 'selected' : '' }}>Bachelor's Degree</option>
                            <option value="Master Degree" {{ $contact->education === 'Master Degree' ? 'selected' : '' }}>Master's Degree</option>
                            <option value="Doctoral Degree" {{ $contact->education === 'Doctoral Degree' ? 'selected' : '' }}>Doctoral Degree</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="input-group input-group-lg input-group-solid">
                            ...
                            <input type="text" name="phone" class="form-control form-control-lg form-control-solid" value="{{ old('phone', $contact->phone) }}"
                                   placeholder="Phone">
                        </div>
                    </div>
                </div>
